...
public final class VistaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonCerrar.setBackground(new java.awt.Color(226, 70, 70));
    ...
    private void btnBorrarMesaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarMesaActionPerformed
        try {
            ...
            if (opcion == JOptionPane.YES_OPTION) {
                if(pedido.buscarPedidoPorMesa(id).getIdPedido()==0){
                con.borrarMesa(id);
                }else{
                     JOptionPane.showMessageDialog(this, "La mesa esta Ocupada no se puede eliminar");
                }
                actualizarTabla();
            }
